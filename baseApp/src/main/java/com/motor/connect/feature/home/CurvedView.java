...
public class CurvedView extends AppCompatTextView {

    private Path myArc;

    private Paint mPaintText;

    public CurvedView(Context context, AttributeSet ats, int defStyle) {
        super(context, ats, defStyle);
        init(ats, context);

    }

    public CurvedView(Context context, AttributeSet ats) {
        super(context, ats);
        init(ats, context);
    }
